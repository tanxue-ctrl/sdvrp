...
time_window = [(0, 30), (0, 200), (50, 150), (60, 350), (250, 300)]
...
for k in range(num_vehicles):
    ...
    for j in range( num_customers + 1):
        ...
        model.addConstr(demand[j]*quicksum(x[i, j, k] for i in range(num_customers + 1)  if i!=j) <= capacity,
